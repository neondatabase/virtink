...
import (
	...
	v1alpha1 "github.com/neondatabase/virtink/pkg/generated/listers/virt/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VirtV1alpha1().VirtualMachines(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VirtV1alpha1().VirtualMachines(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *virtualMachineInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&virtv1alpha1.VirtualMachine{}, f.defaultInformer)
}
